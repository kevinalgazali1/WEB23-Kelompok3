    ...
    <center>
        <div class="hero__content h-75 container-custom position-relative">
            <div class="d-flex h-100 align-items-center hero__content-width">
                <div>
                    <h1 class="hero__heading fw-bold" style="font-size: 50px; color: #222831;">VinTech & Threads</h1>
                    <p class="lead fw-bold" style="color: #222831; font-size: bold">VinTech & Threads adalah toko yang
